// actions/listSimulationRunsAction.ts
...
import { SimulationRunInfo, SimulationRunDownloadInfo } from "../types/scenarios";
 ...
 */
function extractRunIds(blobNames: string[]): string[] {
...
export const listSimulationRunsAction = async (
    ...
    const logger = new ActionLogger('[ListSimulationRunsAction]', loggingLevel);

    try {
        logger.important("=== List Simulation Runs Action Started ===");
        ...
        for (const scenarioId of scenarioIds) {
            try {
                ...
                // Build scenario info
                const scenarioInfo: SimulationRunInfo = {
        ...
        logger.important(`=== List Simulation Runs Action Completed Successfully ===`);
        ...
        logger.error(`=== Error in List Simulation Runs Action ===`);
