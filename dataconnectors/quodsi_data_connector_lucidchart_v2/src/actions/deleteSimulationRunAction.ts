// actions/deleteSimulationRunAction.ts
...
/**
 * Action to delete a simulation run and all its associated files
 * @param action The asynchronous action context
 * @returns Promise resolving with success status
 */
export const deleteSimulationRunAction = async (
    ...
    const logger = new ActionLogger('[DeleteSimulationRunAction]', loggingLevel);

    try {
        logger.important("=== Delete Simulation Run Action Started ===");
        ...
        logger.important("=== Delete Simulation Run Action Completed ===");
        ...
        logger.error("=== Error in Delete Simulation Run Action ===");
