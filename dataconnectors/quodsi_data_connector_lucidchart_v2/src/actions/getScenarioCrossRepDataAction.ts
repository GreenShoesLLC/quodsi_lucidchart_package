// actions/getScenarioCrossRepDataAction.ts
...
/**
 * Action to retrieve scenario cross-replication summary data for a scenario
 * @param action The asynchronous action context
 * @returns Promise resolving with scenario cross-rep data
 */
export const getScenarioCrossRepDataAction = async (
    ...
    const logger = new ActionLogger('[GetScenarioCrossRepData]', loggingLevel);

    try {
        logger.important("=== Get Scenario Cross-Rep Data Action Started ===");
        ...
        logger.info(`Fetching scenario cross-rep data for scenario: ${data.scenarioId} in document: ${data.documentId}`);
        ...
        logger.info(`Retrieved ${scenarioData.length} scenario cross-rep records`);
        logger.important("=== Get Scenario Cross-Rep Data Action Completed ===");
        ...
        logger.error("=== Error in Get Scenario Cross-Rep Data Action ===");
