...
export const EntityThroughputCrossRepSummarySchema: SchemaDefinition = {
    fields: [
        ...
        { name: "throughput_rate_cv", type: ScalarFieldTypeEnum.STRING },
        ...
        { name: "interval_cv", type: ScalarFieldTypeEnum.STRING },
        { name: "first_exit_mean", type: ScalarFieldTypeEnum.STRING },
        { name: "first_exit_median", type: ScalarFieldTypeEnum.STRING },
        { name: "first_exit_std_dev", type: ScalarFieldTypeEnum.STRING },
        { name: "last_exit_mean", type: ScalarFieldTypeEnum.STRING },
        { name: "last_exit_median", type: ScalarFieldTypeEnum.STRING },
        { name: "last_exit_std_dev", type: ScalarFieldTypeEnum.STRING },
    ],
    primaryKey: ["id"],
    fieldLabels: {
        'id': 'ID',
