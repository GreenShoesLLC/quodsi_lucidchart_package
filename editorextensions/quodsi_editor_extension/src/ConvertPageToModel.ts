...
export class ConvertPageToModel {
    ...
    private addInitialConnectorDataToLine(line: LineProxy): void {
        ...
        console.log(`Initial connector data set for Line ID: ${line.id}`);
    }
    /**
    ...
    private processManyOutgoingLines(lines: LineProxy[]): void {
        lines.forEach(line => this.printLineDetails(line, 'Many Outgoing Lines'));
    }
