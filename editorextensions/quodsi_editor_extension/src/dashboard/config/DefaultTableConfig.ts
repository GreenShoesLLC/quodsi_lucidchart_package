    ...
    entityCrossRep: {
        ...
        columns: {
            order: [
                ...
                'time_resource_wait_std_dev',
                'time_queue_wait_mean',
                'time_queue_wait_std_dev',
            ...
            exclude: [
                ...
                'time_resource_wait_median',
                'time_queue_wait_median',
                'time_in_operation_median',
                'time_connecting_mean',
                'time_connecting_median',
                'time_connecting_std_dev',
                'percent_resource_wait_std_dev',
                'percent_queue_wait_std_dev',
