...
// Add this at the top of QuodsiAppV1.tsx
export interface QuodsiAppStateV1 extends AppState {
...
const QuodsiAppV1: React.FC = () => {
  const [state, setState] = useState<QuodsiAppStateV1>({
    editor: null,
    documentId: null,
    isProcessing: false,
    currentLucidId: "",
