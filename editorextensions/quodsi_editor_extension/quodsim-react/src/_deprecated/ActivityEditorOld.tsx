...
import { OperationStepEditorOld } from "./OperationStepEditorOld";
...
const ActivityEditorOld: React.FC<ActivityEditorProps> = ({
  activity,
  onSave,
  onCancel,
  referenceData,
...
export default React.memo(ActivityEditorOld);
