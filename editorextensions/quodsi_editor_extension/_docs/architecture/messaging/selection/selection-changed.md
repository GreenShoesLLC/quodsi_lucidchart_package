...
|--------------|--------------|-------------------|------------------|---------------|
| SELECTION_CHANGED | ➖ N/A | ➖ N/A | ✅ SelectionHandler.sendSelectionChangedMessage | ✅ mapSelection |
| MODEL_CONTEXT | ➖ N/A | ➖ N/A | ✅ DocumentContext.sendContextUpdate | ✅ mapSelection |
