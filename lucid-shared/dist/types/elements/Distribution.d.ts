...
import { ConstantParameters, UniformParameters, TriangularParameters, NormalParameters } from "./distributions";
 ...
 */
export type DistributionParameters = ConstantParameters | MultinomialParameters | UniformParameters | TriangularParameters | ExponentialParameters | NormalParameters | LognormalParameters | BetaParameters | GammaParameters | WeibullParameters | DiscreteParameters | PoissonParameters | BinomialParameters | BernoulliParameters | GeometricParameters | NegativeBinomialParameters | ChiSquareParameters | FDistributionParameters | HypergeometricParameters | LaplaceParameters | LogisticParameters | LogSeriesParameters | ParetoParameters | RayleighParameters | TDistributionParameters | VonMisesParameters | WaldParameters | ZipfParameters;
/**
