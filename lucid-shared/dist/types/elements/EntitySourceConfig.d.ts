 ...
 */
export declare function createDefaultEntitySourceConfig(entityId: string, periodIntervalDuration: Duration): EntitySourceConfig;
/**
 * Creates an EntitySourceConfig for TIME_DISTRIBUTED mode
 */
export declare function createTimeDistributedEntitySourceConfig(entityId: string, timeDistributedConfigIds: string[]): EntitySourceConfig;
//# sourceMappingURL=EntitySourceConfig.d.ts.map