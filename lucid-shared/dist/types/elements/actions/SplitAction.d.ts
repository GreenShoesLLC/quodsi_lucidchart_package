 ...
 */
export declare function createSplitAction(count?: number, options?: Partial<Omit<SplitAction, 'actionType' | 'count' | 'id'>>, id?: string): SplitAction;
/**
 * Type guard for SplitAction
 */
export declare function isSplitAction(action: {
    actionType: ActionType;
}): action is SplitAction;
//# sourceMappingURL=SplitAction.d.ts.map