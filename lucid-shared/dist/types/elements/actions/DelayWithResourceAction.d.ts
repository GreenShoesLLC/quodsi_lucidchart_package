 ...
 */
export declare function createDelayWithResourceAction(duration: Duration, options?: {
    resourceRequirementId?: string | null;
    keepResource?: boolean;
    stateModifications?: StateModification[];
    stateCondition?: StateCondition | null;
}, id?: string): DelayWithResourceAction;
/**
 * Type guard for DelayWithResourceAction
 */
export declare function isDelayWithResourceAction(action: {
    actionType: ActionType;
}): action is DelayWithResourceAction;
//# sourceMappingURL=DelayWithResourceAction.d.ts.map