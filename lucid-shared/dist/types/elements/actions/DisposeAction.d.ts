 ...
 */
export declare function createDisposeAction(stateCondition?: StateCondition | null, id?: string): DisposeAction;
/**
 * Type guard for DisposeAction
 */
export declare function isDisposeAction(action: {
    actionType: ActionType;
}): action is DisposeAction;
//# sourceMappingURL=DisposeAction.d.ts.map