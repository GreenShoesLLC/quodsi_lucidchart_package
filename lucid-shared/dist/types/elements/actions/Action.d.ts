 ...
 */
export type Action = AssignAction | SeizeAction | ReleaseAction | DelayAction | DelayWithResourceAction | SplitAction | CreateAction | DisposeAction | JoinAction | LoopAction | BranchAction;
