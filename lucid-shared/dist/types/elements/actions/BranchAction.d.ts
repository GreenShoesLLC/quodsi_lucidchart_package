 ...
 */
export declare function createBranchAction(options?: Partial<Omit<BranchAction, 'actionType' | 'id'>>, id?: string): BranchAction;
/**
 * Type guard for BranchAction
 */
export declare function isBranchAction(action: {
    actionType: ActionType;
}): action is BranchAction;
//# sourceMappingURL=BranchAction.d.ts.map