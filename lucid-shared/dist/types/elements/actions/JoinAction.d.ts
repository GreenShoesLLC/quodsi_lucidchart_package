 ...
 */
export declare function createJoinAction(options?: Partial<Omit<JoinAction, 'actionType' | 'id'>>, id?: string): JoinAction;
/**
 * Type guard for JoinAction
 */
export declare function isJoinAction(action: {
    actionType: ActionType;
}): action is JoinAction;
//# sourceMappingURL=JoinAction.d.ts.map