 ...
 */
export declare function createDelayAction(duration: Duration, stateCondition?: StateCondition | null, id?: string): DelayAction;
/**
 * Type guard for DelayAction
 */
export declare function isDelayAction(action: {
    actionType: ActionType;
}): action is DelayAction;
//# sourceMappingURL=DelayAction.d.ts.map