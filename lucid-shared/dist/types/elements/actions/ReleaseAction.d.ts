 ...
 */
export declare function createReleaseAction(resourceRequirementId: string, stateCondition?: StateCondition | null, id?: string): ReleaseAction;
/**
 * Type guard for ReleaseAction
 */
export declare function isReleaseAction(action: {
    actionType: ActionType;
}): action is ReleaseAction;
//# sourceMappingURL=ReleaseAction.d.ts.map