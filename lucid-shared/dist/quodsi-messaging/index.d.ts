...
import { ModelRunRequestMessage, ModelRunStatusMessage, SimulationMessage } from './simulation/messages';
...
import { EntitlementMessage, EntitlementsStatusMessage } from './entitlements/messages';
import { AnalyticsMessage, AnalyticsTrackMessage } from './analytics/messages';
...
export { EnvelopeBase, MessageSource, MessageTarget, isEnvelope } from './envelope/envelope';
export { createMessageTypeGuard, isFromSource, isForTarget, hasRequiredDataFields } from './envelope/guards';
export { ReactAppReadyMessage, ErrorMessage, LogMessage, FrameworkMessage } from './framework/messages';
export { QuodsiUserInfo, ExtensionConfig, AuthLoginSuccessMessage, AuthLogoutMessage, AuthStatusMessage, AuthRequiredMessage, AuthErrorMessage, AuthMessage } from './auth/messages';
export { ElementShape, ModelContextMessage, SelectionChangedMessage, SelectionMessage } from './selection/messages';
export { SimulationStatus, SimulationJob, ModelRunRequestMessage, ModelRunStatusMessage, SimulationMessage } from './simulation/messages';
export { ValidationSeverity, ValidationIssue, ValidationResult, ModelValidateMessage, ModelValidationResultMessage, ModelConvertMessage, ModelConversionResultMessage, ModelRemoveMessage, ModelRemoveResultMessage, ModelJsonRequestMessage, ModelJsonResponseMessage, ModelOpsMessage } from './modelOps/messages';
export { ElementSelectMessage, ElementUpdateMessage, ElementUpdateResultMessage, ElementConvertMessage, ElementConvertResultMessage, StatesUpdateMessage, StatesUpdateResultMessage, ResourceRequirementsUpdateMessage, ResourceRequirementsUpdateResultMessage, TimePatternsUpdateMessage, TimePatternsUpdateResultMessage, TimeDistributedConfigsUpdateMessage, TimeDistributedConfigsUpdateResultMessage, ElementOpsMessage } from './elementOps/messages';
export { StorageProvider, ConnectionStatus, StorageConnectRequestMessage, StorageConnectResultMessage, StorageDisconnectMessage, StorageStatusMessage, StorageMessage } from './storage/messages';
export { SimulationRunInfo, SimulationRunDownloadInfo, SimulationRunListRequestMessage, SimulationRunListResultMessage, SimulationRunDeleteMessage, SimulationRunDeleteResultMessage, SimulationRunResimulateRequestMessage, SimulationRunCancelRequestMessage, SimulationRunCancelResultMessage, CrossRepDataRequestMessage, CrossRepDataResultMessage, CrossRepBatchDataRequestMessage, CrossRepBatchDataResultMessage, CrossRepDataType, SimulationRunMessage } from './simulationRun/simulationRunMessages';
export { ConversionPreviewRequestMessage, ConversionPreviewResultMessage, ConversionApplyMessage, ConversionApplyResultMessage, ConversionPreviewMessage } from './conversionPreview/messages';
export { EntitlementsStatusMessage, EntitlementSubjectType, EntitlementPlanStatus, EntitlementMeteredFeature, EntitlementMessage } from './entitlements/messages';
export { AnalyticsMessage, AnalyticsTrackMessage, ClientAnalyticsEvent } from './analytics/messages';
export { SyncAllRequestMessage, SyncAllSuccessMessage, SyncAllErrorMessage, SyncAllRequestData, SyncAllSuccessData, SyncAllErrorData, SyncMessage } from './sync/messages';
export type QuodsiMessage = FrameworkMessage | AuthMessage | SelectionMessage | SimulationMessage | ModelOpsMessage | ElementOpsMessage | StorageMessage | SimulationRunMessage | ConversionPreviewMessage | EntitlementMessage | AnalyticsMessage | SyncMessage;
export interface EnvelopMessagePayloads {
    ...
    [EnvelopeMessageType.OPEN_RESULTS_MODAL]: {
        scenarioId: string;
        documentId: string;
        useEmbeddedStudio?: boolean;
        modalSize?: import('../config/modalSize').ModalSize;
    };
    [EnvelopeMessageType.OPEN_ANIMATION_MODAL]: {
        scenarioId: string;
        modalSize?: import('../config/modalSize').ModalSize;
    };
    [EnvelopeMessageType.OPEN_SCENARIOS_MODAL]: {
        documentId: string;
        pageId: string;
        modalSize?: import('../config/modalSize').ModalSize;
    };
    ...
    [EnvelopeMessageType.DEVTOOLS_KINDE_AUTH_RESULT]: {
        success: boolean;
        claims?: Record<string, any>;
        error?: string;
    };
    [EnvelopeMessageType.SWIMLANE_UPDATE]: {
        swimlaneBlockId: string;
        swimlaneData: import('../types/swimlane/SwimLaneQuodsiData').SwimLaneQuodsiData;
    };
    [EnvelopeMessageType.SWIMLANE_UPDATE_RESULT]: {
        success: boolean;
        errorMessage?: string;
    };
    [EnvelopeMessageType.SWIMLANE_CONVERT_LANE]: {
        swimlaneBlockId: string;
        laneIndex: number;
        resourceName: string;
    };
    [EnvelopeMessageType.SWIMLANE_CONVERT_LANE_RESULT]: {
        success: boolean;
        swimlaneBlockId: string;
        swimlaneData?: import('../types/swimlane/SwimLaneQuodsiData').SwimLaneQuodsiData;
        error?: string;
 ...
 */
export declare function isValidEnvelopMsg(value: unknown): value is QuodsiMessage;
