 ...
 */
export declare function createMessageTypeGuard<T extends EnvelopeMessageType>(type: T): (msg: EnvelopeBase) => msg is EnvelopeBase & {
    type: T;
};
/**
 ...
 */
export declare function isFromSource(source: 'host' | 'model-iframe' | 'auth-iframe'): (msg: EnvelopeBase) => boolean;
/**
 ...
 */
export declare function isForTarget(target: 'host' | 'model-iframe' | 'auth-iframe' | 'broadcast'): (msg: EnvelopeBase) => boolean;
/**
 ...
 */
export declare function hasRequiredDataFields(requiredFields: string[]): (msg: EnvelopeBase) => boolean;
