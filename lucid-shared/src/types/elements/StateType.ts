 ...
 */
export function isArithmeticSupported(stateType: StateType): boolean {
 ...
 */
export function getSupportedOperations(stateType: StateType): string[] {
 ...
 */
export function validateValueType(stateType: StateType, value: any): boolean {
    switch (stateType) {
