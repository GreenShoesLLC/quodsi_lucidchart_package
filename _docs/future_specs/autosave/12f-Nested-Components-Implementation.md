          ...
          setValidators([
            ...
            ...localData.operationSteps.flatMap((_, index) => [
              ...
              },
              {
                ...
                validate: (value) =>
                  validateInteger(value, "Resource Quantity"),
              },
            ]),
          ]);
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener(
        "nestedComponentAutosave",
        handleNestedAutosave
      );
    };
...
const OperationStepEditor: React.FC<OperationStepEditorProps> = (props) => {
  ...
  const { registerForAutosave, triggerAutosave, validationErrors } =
  ...
  const getFieldPath = (field: string) =>
    `operationSteps[${props.index}].${field}`;
        ...
        useEffect(() => {
          ...
          const validators = [
            ...
            },
            {
              ...
              validate: (value) => validateBasic(value, "Inbound Queue"),
            },
